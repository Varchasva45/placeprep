            ...
            <div>
                <div className='relative isolate'>
                    ...
                    <div className='max-w-5xl mx-auto mb-32 mt-32 sm:mt-48'>
                        ...
                        <ol className='pt-8 my-8 space-y-12 md:flex md:space-x-12 md:space-y-0'>
                            <li className='md:flex-1'>
                                <div className='flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4'>
                                    ...
                                    <span className='mt-2 text-zinc-700'>
                                        ...
                                        <Link to={'/pricing'} className='text-blue-700 underline underline-offset-2'>
                                            pro plan
                                        </Link>
                                        .
                                    </span>
                            ...
                            <li className='md:flex-1'>
                                <div className='flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4'>
                                    ...
                                    <span className='mt-2 text-zinc-700'>
                                        Its that simple. Try it out today - It takes less than a minute.
                                    </span>
                                </div>
                            </li>
                        </ol>
