    ...
    <>
      <MaxWidthWrapper className="mb-16 mt-16 sm:mt-10 flex flex-col items-center justify-center text-center">
        ...
        <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
          AI Interviews provides a realistic interview experience with an AI
          interviewer. Practice in real-time for your target job profile and
          refine your skills.
        </p>
          ...
          <section className="w-full">
            <div className="container px-4 md:px-6">
              <div className="grid lg:grid-cols-2 lg:gap-12 gap-6">
                <div
                  style={{ backgroundColor: "rgb(229,240,255)" }}
                  className="rounded-lg p-6 flex flex-col items-center justify-center text-center shadow-md"
                >
                  ...
                  <p className="text-muted-foreground">
                    Streamline your hiring process with our AI-powered interview
                    assistant. Get instant feedback and insights to make
                    informed decisions.
                  </p>
                  <Link
                    className={buttonVariants({
                ...
                >
                  ...
                  <p className="text-muted-foreground">
                    Collaborate with your team and candidates in a virtual
                    interview setting. Easily assess and compare candidates with
                    our group interview features.
                  </p>
                  <Link
                    className={buttonVariants({
                      size: "lg",
            ...
            <div className="mb-16 px-6 lg:px-8">
              <div className="mx-auto max-w-3xl sm:text-center">
                ...
                <p className="mt-4 text-lg text-gray-600">
                  Preparing for interviews has never been easier than with
                  PlacePrep.
                </p>
              </div>
            </div>
            ...
            <ol className="pt-8 mx-3 mb-8 mt-4 space-y-12 md:flex md:space-x-12 md:space-y-0">
              <li className="md:flex-1">
                <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
                  ...
                  <span className="mt-2 text-zinc-700">
                    Practice for your target job profile. Either start with a
                    free plan or go for our{" "}
                    <Link
                      to={"/pricing"}
              ...
              <li className="md:flex-1">
                <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
                  ...
                  <span className="mt-2 text-zinc-700">
                    Get detailed analysis of your interview performance and
