                            ...
                            <div>
                                {auth.isAuthenticated ? (
                                        user.isSubscribed ? (
                                            ...
                                            <div className="flex items-center justify-center">
                                                {plan !== 'Pro' ?
                                                    <Link to={'/'} className={cn(buttonVariants(),'w-full mx-2 mt-3 mb-2 bg-gray-200 text-black flex items-center justify-center hover:bg-gray-300 cursor-pointer')}>
                                                        Get Started
                                                        <ArrowRight className='w-5 h-5'/> 
                                                    </Link>
                                                :   <Link to={'/pricing'} className={cn(buttonVariants(),'w-full mx-2 mt-3 mb-2 bg-blue-600 text-white hover:bg-blue-500 cursor-pointer flex items-center justify-center')}>
                                                        Upgrade
                                                        <ArrowRight className='w-5 h-5'/> 
                                                    </Link>
                                                }
                                    ...
                                    <Link to={'/signup'} className={cn(buttonVariants(), plan === 'Pro' ? 'w-[95%] mb-2 mx-2 bg-blue-600 text-white items-center hover:bg-blue-500 cursor-pointer' :'w-[95%] mb-2 mx-2 bg-gray-200 text-black items-center hover:bg-gray-300 cursor-pointer')}>
                                        <div className='flex items-center justify-center'>
